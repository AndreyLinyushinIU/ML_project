...
def main(content_path: str, style_path: str, output_path: str, num_steps=100, save_each=20, lr=0.1) -> None:
	...
	input = content.clone()
	def style_transfer(cnn, content, style, input_img, num_steps,
	                   style_weight=1000000, content_weight=1):
	    
	    net, style_losses, content_losses = get_style_model(cnn,
	        style, content)
